  ...
  public void actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      if (id == 1) {
        ...
        referenceReservation = view.numReservation.getText();
        int nuits=0, categorie=0, numDeChambre=0,idClient = 0;
        PreparedStatement listeReservRef = connexion.prepareStatement("SELECT * FROM Reservation WHERE referenceReservation='"+referenceReservation+"' AND debut='2018-01-06'");
        ResultSet resultListRef = listeReservRef.executeQuery();
        while (resultListRef.next()) {
          referenceReservation = resultListRef.getString(2);
        ...
        view.caracChambre.setText("Ref: "+referenceReservation+" Nuits: "+nuits+" Categorie: "+categorie+" Numero de chambre: "+numDeChambre);
        ...
        int nuits=0,categorie=0, numDeChambre=0, idClient=0;
        String referenceReservation="ab";
        ...
        if (resultatReservation.first()) {
          referenceReservation=resultatReservation.getString(2);
